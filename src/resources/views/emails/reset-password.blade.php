                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                                ...
                                <tr>
                                    <td style="padding-bottom: 20px;">
                                        <h1 style="margin: 0; font-size: 28px; font-weight: 700; letter-spacing: -0.02em; color: #0f172a; line-height: 1.2;">Reset your password</h1>
                                    </td>
                                </tr>
                                        ...
                                        <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                                            <tr>
                                                <td style="background: linear-gradient(135deg, #0f5ef7 0%, #1480ff 100%); border-radius: 16px; box-shadow: 0 18px 40px rgba(15, 94, 247, 0.28);">
                                                    <a href="{{ $url }}" style="display: inline-block; padding: 16px 36px; color: #ffffff; text-decoration: none; font-size: 15px; font-weight: 600; border-radius: 16px;">Reset Password</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
